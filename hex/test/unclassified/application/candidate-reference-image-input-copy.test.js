...
// Unclassified candidate: source-neutral image-input copy is the likely destination, but exact
...
//
// Decision: keep unclassified. Promote only after the reference-image input
...
// Unclassified candidate: replacement failure should probably reassure that the current image
