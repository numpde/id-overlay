...
// Unclassified candidate: the fallback behavior is stable, but this test specifies the
...
// Unclassified candidate: cancellation must be request-bound, but this version talks to a fake
