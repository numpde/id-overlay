...
// Unclassified candidate: placement command laws are class-a; this candidate is about the
...
// Unclassified candidate: rotate/scale should converge on the same placement command shape, but
// this test currently chooses the wheel-fact vocabulary and projection port.
// Keep it unclassified until those are adapter facts, not product assumptions.
...
// Unclassified candidate: opacity durability and non-history posture are class-a. This composed
...
// Unclassified candidate: Trace/native-map posture is class-a for placement input, but this
