...
test("bootstrap wiring does not inspect product state or execute app behavior", () => {
  ...
  const runtime = wireRuntime({
    ...
    createRuntimeDriver(dependencies) {
      trace.edge(flowEdge("source.bootstrap-wire-runtime", "sink.runtime-factory", {
  ...
  trace.edge(flowEdge("source.bootstrap-wire-runtime", "sink.runtime-instance", {
    terminal: "composition-result",
  }));
  ...
  assert.deepEqual(trace.edges, [
    flowEdge("source.bootstrap-wire-runtime", "sink.runtime-factory", {
      terminal: "composition-result",
    }),
    flowEdge("source.bootstrap-wire-runtime", "sink.runtime-instance", {
      terminal: "composition-result",
    }),
  ]);
});
